...
import 'simulation_non_pharmacological_screen.dart';
...
/// Tela de escolha do medicamento na simulação
class SimulationMedicationChoiceScreen extends StatefulWidget {
  final String patientName;
  final int patientAge;

  const SimulationMedicationChoiceScreen({
    super.key,
  ...
  @override
  State<SimulationMedicationChoiceScreen> createState() =>
      _SimulationMedicationChoiceScreenState();
}

class _SimulationMedicationChoiceScreenState
    extends State<SimulationMedicationChoiceScreen> {
  int? _selectedOption;
  bool _hasAnswered = false;
  bool _isWrong = false;

  static const int _correctIndex = 1; // B - BRA (Losartana)
  static const String _drAxonTipCorrect = 'BRA protege rim e coração e é primeira linha.';
  static const String _drAxonTipWrong = 'Para HAS com critérios apresentados, BRA é primeira linha. BRA protege rim e coração e é primeira linha.';
  static const String _whyWrongA = 'Betabloqueador isolado não é primeira linha para HAS sem indicação específica (ex.: pós-IAM).';
  static const String _whyWrongC = 'Antiarrítmico não é indicado para tratamento de hipertensão arterial.';
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: GlassCard(
                          ...
                          child: Text(
                            'Critérios Apresentados: Eficácia, proteção cardiovascular, boa tolerabilidade, disponibilidade no SUS.',
                            style: r.bodyMedium.copyWith(
                              color: AppColors.grayText,
                            ),
                          ),
                      ...
                      // Seção de escolha do medicamento
                      Text(
  ...
  void _onOptionTap(int index) {
    ...
    void goNext() {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SimulationNonPharmacologicalScreen(
            patientName: widget.patientName,
            patientAge: widget.patientAge,
          ),
        ),
    ...
    if (isCorrect) {
      ...
      _showDrAxonTipPopup(
        ...
        correctAnswerText: 'BRA (Losartana)',
        onContinue: goNext,
      );
    }
  }
