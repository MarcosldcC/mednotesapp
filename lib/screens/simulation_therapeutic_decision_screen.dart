...
import 'simulation_medication_choice_screen.dart';
...
/// Tela de decisão terapêutica na simulação
class SimulationTherapeuticDecisionScreen extends StatefulWidget {
  final String patientName;
  final int patientAge;

  const SimulationTherapeuticDecisionScreen({
    super.key,
  ...
  @override
  State<SimulationTherapeuticDecisionScreen> createState() =>
      _SimulationTherapeuticDecisionScreenState();
}

class _SimulationTherapeuticDecisionScreenState
    extends State<SimulationTherapeuticDecisionScreen> {
  int? _selectedOption;
  bool _hasAnswered = false;
  bool _isWrong = false;

  static const int _correctIndex = 1; // B - Iniciar medicação + estilo de vida
  static const String _drAxonTipCorrect = 'Risco moderado já justifica intervenção farmacológica precoce.';
  static const String _drAxonTipWrong = 'Com risco cardiovascular moderado, as diretrizes recomendam associar medicação às mudanças de estilo de vida.';
  static const String _whyWrongA = 'Apenas estilo de vida é insuficiente quando o risco cardiovascular é moderado; medicação está indicada.';
  static const String _whyWrongC = 'Múltiplas drogas não são primeira linha; deve-se iniciar com monoterapia e ajustar conforme resposta.';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MultipleChoiceOption(
                        letter: 'A',
                        text: 'Apenas mudanças de estilo de vida',
                      ...
                      MultipleChoiceOption(
                        letter: 'B',
                        text: 'Iniciar medicação + estilo de vida',
                      ...
                      MultipleChoiceOption(
                        letter: 'C',
                        text: 'Prescrever múltiplas drogas',
  ...
  void _onOptionTap(int index) {
    ...
    void goNext() {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SimulationMedicationChoiceScreen(
            patientName: widget.patientName,
            patientAge: widget.patientAge,
          ),
        ),
    ...
    if (isCorrect) {
      ...
      _showDrAxonTipPopup(
        ...
        correctAnswerText: 'Iniciar medicação + estilo de vida',
        onContinue: goNext,
      );
    }
  }
